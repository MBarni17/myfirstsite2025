...
<nav>
 ...
 <ul id="menu">
        <li><a class="{{ Request::path() === '/' ? 'active' : ''}}" href="/" aria-current="page">Home</a></li>
        <li><a class="{{ Request::path() === 'udvozles' ? 'active' : ''}}" href="/udvozles" >Udvozles</a></li>
        <li><a class="{{ Request::path() === 'contact' ? 'active' : ''}}" href="/contact" >Contact</a></li>
        <li><a class="{{ Request::path() === 'bevasarlolista' ? 'active' : ''}}" href="/bevasarlolista" >Bevasarlas</a></li>
        <li><a class="{{ Request::path() === 'felhasznaloiadat' ? 'active' : ''}}" href="/felhasznaloiadat?felhasznalonev=MB&vezeteknev=Barney&keresztnev=Mark" >Felhasznalo</a></li>
 </ul>
</nav>
<!-- // -->
<!-- Banner -->
